<template xmlns:font-color="http://www.w3.org/1999/xhtml">
  <div class="app-container" style="min-height: 100%">
    ...
    <el-table   v-loading="loading" :data="tableData"   border style="width: 100% " @selection-change="handleSelectionChange" :default-sort="{ prop: 'startTime', order: 'ascending' }">
      ...
      <el-table-column label="工具类别" width="130" align="center" sortable prop="bigType" >
        <template slot-scope="scope">
        ...
        <el-row>
          <el-col :span="22">
            <el-form-item label="备注" prop="toolNote" :label-width="formLabelWidth">
              <el-input   maxlength="256"  show-word-limit rows=4 type="textarea" v-model="dataForm.toolNote" placeholder="请输入备注" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
import { fetchList, addCourse, updateCourse, deleteCourse, deleteBatchCourse, fetchOrderList, getSingleToolInfo } from '@/api/tool'
...
export default {
  ...
  methods: {
    ...
    getCourseList: function() {
      ...
      params.append('toolWarehourse', this.warehourseIdParams)
