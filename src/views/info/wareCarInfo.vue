  ...
  <div class="app-container" style="min-height: 100%">
    ...
    <el-table v-loading="loading" :data="tableData" border style="width: 100% " :default-sort="{ prop: 'startTime', order: 'ascending' }" @selection-change="handleSelectionChange">      <el-table-column type="selection" />
      ...
      <el-table-column label="状态" width="120" align="center">
        <template slot-scope="scope">
          <div>
            <el-tag   style="margin-bottom: 2px" v-if="scope.row.testState=== 2" size="small" type="info">试验不合格</el-tag>
          </div>
          <div>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="所属仓库" prop="warehourseName" :label-width="formLabelWidth">
              <!--<el-input v-model="dataForm.courseDept" placeholder="请输培训部门" />-->
              <el-select v-model="dataForm.warehourseName"  @click.native="warehoueseClick" clearable placeholder="请选择" @change="wareCurrentChangeHandle2">
                <el-option
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="车高(m)" prop="carHeight" :label-width="formLabelWidth">
              <el-input-number v-model="dataForm.carHeight" :min="0" :controls="false" :precision="2" placeholder="请输入车高"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="8">
        ...
        <el-row>
          <el-col :span="22">
            <el-form-item label="备注" prop="carNote" :label-width="formLabelWidth">
              <el-input   maxlength="256"  show-word-limit rows=5 v-model="dataForm.carNote" type="textarea"  placeholder="请输入备注" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  data() {
    return {
      warehourseIdParams: this.$route.params.id,
      checkId: null,
      size: 'small',
      tableData: [],
      stateOptions: [
  ...
  methods: {
    ...
    getCarList: function() {
      ...
      params.append('warehourseId', this.warehourseIdParams)
