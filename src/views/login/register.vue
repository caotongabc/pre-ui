...
<!--          </el-form-item>-->
          ...
          <el-form-item prop="deptName" >
            <popup-tree-input
              :data="registerForm.deptData"
              :props="deptTreeProps"
              :prop="registerForm.deptName"
              placeholder="请选择单位"
              :node-key="registerForm.deptName"
...
import { getDeptInRegister } from '@/api/dept'
...
export default {
  ...
  methods: {
    ...
    findDeptTree: function() {
      getDeptInRegister().then((res) => {
        this.registerForm.deptData = res.data.data
      })
    },
    // 部门菜单树选中
    deptTreeCurrentChangeHandle(data) {
      this.registerForm.deptId = data.deptId
      this.registerForm.deptName = data.name
    },
    sendCode() {
